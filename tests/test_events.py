...
from tonika_bus.core.events import ModuleStatus, EventMetadata, TonikaEvent
...
class TestEventMetadata:
    ...
    def test_create_with_defaults(self):
        """Test EventMetadata.create() with default values"""
    ...
    def test_metadata_equality(self):
        ...
        meta1 = EventMetadata(source="Test", version="1.0.0", timestamp=timestamp)
        meta2 = EventMetadata(source="Test", version="1.0.0", timestamp=timestamp)
        meta3 = EventMetadata(source="Other", version="1.0.0", timestamp=timestamp)
    ...
    def test_metadata_with_custom_timestamp(self):
        ...
        meta = EventMetadata(source="Test", version="1.0.0", timestamp=custom_time)
...
class TestTonikaEvent:
    ...
    def test_event_equality(self):
        ...
        # Note: These will likely not be equal due to different timestamps
        event1 = TonikaEvent(type="test:event", detail={"data": 1}, _meta=meta1)
        event2 = TonikaEvent(type="test:event", detail={"data": 1}, _meta=meta2)

        # Events with different metadata timestamps will not be equal
        # This is expected behavior
        assert event1.type == event2.type
        assert event1.detail == event2.detail
    ...
    def test_event_metadata_accessible(self):
        ...
        assert isinstance(event._meta.timestamp, datetime)
